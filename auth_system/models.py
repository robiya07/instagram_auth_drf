...
class User(AbstractUser, BaseModel):
    ...
    def check_username(self):
        if not self.username:
            temp_username = f'instagram-{uuid.uuid4().__str__().split("-")[-1]}'  # instagram-23324fsdf uuid:
...
class UserConfirmation(BaseModel):
    ...
    user = models.ForeignKey('auth_system.User', models.CASCADE, related_name='verify_codes')
